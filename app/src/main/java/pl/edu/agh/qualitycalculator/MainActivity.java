...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnAvg = (Button) findViewById(R.id.avgBttn);
    ...
    public void onClick(View v) {
        if (TextUtils.isEmpty(etNum1.getText().toString())
            ...
            tvResult.setText("No operand value");
            return;
        }
        ...
        if(TextUtils.isEmpty(etNum3.getText().toString()) && selectedOperation.equals(Operation.AVERAGE)){
            tvResult.setText("No operand value");
            return;
        }
        ...
        float num3;
        if(selectedOperation.equals(Operation.AVERAGE)){
